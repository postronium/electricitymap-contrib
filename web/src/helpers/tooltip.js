...
module.exports.showLowCarbon = function showLowCarbon(tooltipInstance, country, displayByEmissions, co2color, co2Colorbars, electricityMixMode) {
  const selector = tooltipInstance._selector;
  const mode = "wind";
...
module.exports.showRenewable = function showRenewable(tooltipInstance, mode, country, displayByEmissions, co2color, co2Colorbars, electricityMixMode) {
  const selector = tooltipInstance._selector;
